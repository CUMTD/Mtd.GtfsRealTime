...
public class TripUpdatesController : ProtoPassThroughController
{
	private readonly GtfsRealTimeConfig _gtfsRealTimeConfig;

	public TripUpdatesController(IOptions<GtfsRealTimeConfig> gtfsRealTimeConfig, HttpClient httpClient,  ILogger<TripUpdatesController> logger): base(httpClient, logger)
	{
